...
class FileAPI:
    ...
    async def _radio_command(self, data, writer):
        ...
        if action == "power_on":
            ...
            radio.command(0x0A, _subghz_payload(data))
        elif action == "subghz_sniff":
            radio.command(0x0B, _subghz_payload(data))
        elif action == "spectrum_sweep":
            radio.command(0x0F, _subghz_payload(data))
            ...
            radio.command(0x0D, _subghz_payload(data))
        elif action == "replay":
            radio.command(0x0C, _subghz_payload(data))
